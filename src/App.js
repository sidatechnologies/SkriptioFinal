...
import { Loader2, Upload, FileText, ListChecks, BookOpen, Calendar, ArrowRight, Check, Sparkles, Layers, GraduationCap, Shield, Clock, Users, HelpCircle, Zap, Instagram, Twitter, Linkedin, Facebook, Mail, Menu } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="md:hidden">
              <button aria-label="Open menu" className="p-2 rounded-md border border-border" onClick={() => setMobileOpen(true)}>
                <Menu size={18} />
              </button>
            </div>
            <ThemeToggle />
