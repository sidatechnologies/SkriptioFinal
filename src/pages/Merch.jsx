...
export default function Merch() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Header (mirrors landing header styling) */}
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-background/60 border-b border-border">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="hidden lg:flex items-center gap-6 text-sm text-foreground/80 mr-2">
              <Link to="/">Home</Link>
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          {/* Column 2: Coming soon glass placeholder */}
          <div className="relative border border-border rounded-xl overflow-hidden backdrop-blur-sm bg-white/10 dark:bg-white/5">
            <div className="p-4 flex items-center justify-between border-b border-border/70">
              <div className="font-medium">Study Kit Templates</div>
