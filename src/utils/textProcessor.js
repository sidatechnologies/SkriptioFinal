...
export function ensureSentence(text = '') { let t = String(text || '').trim(); if (!t) return ''; t = charCleanupLight(t); t = fixMidwordSpaces(fixSpacing(t)); if (!/[\.!?]$/.test(t)) t += '.'; t = t.charAt(0).toUpperCase() + t.slice(1); return t.trim(); }
